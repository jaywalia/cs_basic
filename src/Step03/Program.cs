...
namespace Step03
{
    class Program
    {
        public static void Main()
        {
            ...
            // Console.WriteLine(Step03Extensions.Power(2,3));
            // //(2.0).Power(3);
            // Console.WriteLine("jay walia".Capitalize());
            ...
            //========================================================
            Console.WriteLine($"1,2,3,4 mean is : {Adder.Mean_IntDiv(1,2,3,4)}"); // 2.0
            Console.WriteLine($"1,2,3,4 mean is : {Adder.Mean_FloatDiv(1,2,3,4)}"); // 2.5
            Console.WriteLine($"1.1,2.1,3.1,4.1 mean is : {Adder.Mean_Doubles(1.1,2.1,3.1,4.1)}"); // 2.6

            // double d2 = 2.0;
            // int i2 = d2; 
            Console.WriteLine($"1.1,2.1,3.1,4.1 mean is : {Adder.Mean_Foreach(1.1,2.1,3.1,4.1)}"); //2.5
